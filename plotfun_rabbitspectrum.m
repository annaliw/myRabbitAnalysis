function trash = plotfun_rabbitspectrum(IP, wavelength, E, E_SpectraArray, mode)
    ...
    if strcmp(mode,'twoOmega')==1
        ...
        line(E, movmean(twoOmega_abs./(mean(abs(E_SpectraArray), 2)), 4), ...
