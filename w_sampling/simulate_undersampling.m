...
if truncate_1 == 1
    ...
    wrange_1 = 1/dt_1/2;
    w_1 = (-wrange_1+dw_1):dw_1:wrange_1;  
end
...
% find fit regions
window = 3; 
[~,tmp] = findpeaks(abs(signal_w_1ft), 'MinPeakProminence', max(abs(signal_w_1ft)/20)); 
center_1w_1 = tmp(4); 
[~,tmp] = findpeaks(abs(signal_w_1ft), 'MinPeakProminence', max(abs(signal_w_1ft)/20)); 
center_2w_1 = tmp(5); 
[~,tmp] = findpeaks(abs(signal_w_2ft), 'MinPeakProminence', max(abs(signal_w_2ft)/20)); 
center_1w_2 = tmp(5); 
[~,tmp] = findpeaks(abs(signal_w_2ft), 'MinPeakProminence', max(abs(signal_w_2ft)/20)); 
center_2w_2 = tmp(4); 
